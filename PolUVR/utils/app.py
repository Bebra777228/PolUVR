...
with gr.Blocks(
        ...
        with gr.Group():
            with gr.Row():
                roformer_model = gr.Dropdown(
                    label="Select the Model", choices=list(ROFORMER_MODELS.keys())
                )
            with gr.Row():
                ...
                roformer_overlap = gr.Slider(
                    ...
                    value=8,
                    label="Overlap",
                    info="Amount of overlap between prediction windows. Lower is better but slower.",
                )
                roformer_pitch_shift = gr.Slider(
                    ...
                    value=0,
                    label="Pitch shift",
                    info="Shift audio pitch by a number of semitones while processing. may improve output for deep/high vocals.",
                )
        with gr.Row():
        ...
        with gr.Group():
            with gr.Row():
                mdx23c_model = gr.Dropdown(
                    label="Select the Model", choices=MDX23C_MODELS
                )
            with gr.Row():
                ...
                mdx23c_overlap = gr.Slider(
                    ...
                    value=8,
                    label="Overlap",
                    info="Amount of overlap between prediction windows. Higher is better but slower.",
                )
        ...
        with gr.Group():
            ...
            with gr.Row():
                ...
                mdx_denoise = gr.Checkbox(
                    value=False,
                    label="Denoise",
                    info="Enable denoising after separation.",
                )
        with gr.Row():
        ...
        with gr.Group():
            with gr.Row():
                demucs_model = gr.Dropdown(
                    label="Select the Model", choices=DEMUCS_MODELS
                )
            with gr.Row():
    ...
    with gr.Tab("Settings"):
        with gr.Accordion("General settings", open=False):
            with gr.Group():
                model_file_dir = gr.Textbox(
                    ...
                    label="Directory to cache model files",
                    info="The directory where model files are stored.",
                ...
                with gr.Row():
                    output_dir = gr.Textbox(
                        ...
                        info="The directory where output files will be saved.",
                        placeholder="output",
                    )
                    output_format = gr.Dropdown(
                        ...
                        label="Output Format",
                        info="The format of the output audio file.",
                    )
                with gr.Row():
        ...
        with gr.Accordion("Rename Stems", open=False):
            ...
            gr.HTML(
                "<h3> Output File Name: Music_(Vocals)_BS-Roformer-Viperx-1297 </h3>"
            )
            with gr.Row():
                vocals_stem = gr.Textbox(
                    value="NAME_(STEM)_MODEL",
                    label="Vocals Stem",
                    info="Output example: Music_(Vocals)_BS-Roformer-Viperx-1297",
                    placeholder="NAME_(STEM)_MODEL",
                )
                instrumental_stem = gr.Textbox(
                    value="NAME_(STEM)_MODEL",
                    label="Instrumental Stem",
                    info="Пример вывода: Music_(Instrumental)_BS-Roformer-Viperx-1297",
                    placeholder="NAME_(STEM)_MODEL",
                )
                other_stem = gr.Textbox(
                    value="NAME_(STEM)_MODEL",
                    label="Other Stem",
                    info="Output example: Music_(Other)_BS-Roformer-Viperx-1297",
                    placeholder="NAME_(STEM)_MODEL",
                )
            with gr.Row():
                drums_stem = gr.Textbox(
                    value="NAME_(STEM)_MODEL",
                    label="Drums Stem",
                    info="Output example: Music_(Drums)_BS-Roformer-Viperx-1297",
                    placeholder="NAME_(STEM)_MODEL",
                )
                bass_stem = gr.Textbox(
                    value="NAME_(STEM)_MODEL",
                    label="Bass Stem",
                    info="Output example: Music_(Bass)_BS-Roformer-Viperx-1297",
                    placeholder="NAME_(STEM)_MODEL",
                )
            with gr.Row():
                guitar_stem = gr.Textbox(
                    value="NAME_(STEM)_MODEL",
                    label="Guitar Stem",
                    info="Output example: Music_(Guitar)_BS-Roformer-Viperx-1297",
                    placeholder="NAME_(STEM)_MODEL",
                )
                piano_stem = gr.Textbox(
                    value="NAME_(STEM)_MODEL",
                    label="Piano Stem",
                    info="Output example: Music_(Piano)_BS-Roformer-Viperx-1297",
                    placeholder="NAME_(STEM)_MODEL",
                )
