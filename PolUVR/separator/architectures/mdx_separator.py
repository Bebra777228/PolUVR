...
class MDXSeparator(CommonSeparator):
    ...
    def __init__(self, common_config, arch_config):
        ...
        if self.hop_length < 32:
            self.logger.warning(
                f"hop_length {self.hop_length} is less than the minimum allowed value of 32. Setting hop_length to 32."
            )
            self.hop_length = 32
        elif self.hop_length > 2048:
            self.logger.warning(
                f"hop_length {self.hop_length} is greater than the maximum allowed value of 2048. Setting hop_length to 2048."
            )
